        ...
        },
        {
          ...
          grades: [
            ...
            },
            {
              ...
              color: "#F59E0B",
              items: [
                "Abaixo do umbigo até joelhos",
                "BT estimada: ~11 mg/dL",
              ],
            },
            {
              grade: "4",
  ...
  },
  {
    ...
    content: {
      ...
      blocks: [
        ...
        {
          type: "obs",
          title: "Relação Bilirrubina/Albumina (B/A) — Critério Auxiliar AAP 2022",
  ...
  },
  {
    ...
    content: {
      ...
      blocks: [
        ...
        {
          type: "obs",
          title: "Fotoisomerização — Mecanismo da Fototerapia e Relevância no Gilbert",
  ...
  },
  {
    ...
    content: {
      ...
      blocks: [
        ...
        {
          type: "obs",
          title: "Armadilha Clássica — Coombs Negativo na Incompatibilidade ABO",
          ...
          >
            {block.items.map((item, i) => (
              <div
                key={i}
                style={{
                  background: item.highlight ? `${color}0a` : "#080d18",
                  border: `1px solid ${
                    item.highlight ? color + "33" : "#111827"
                  }`,
                  borderRadius: 5,
                  padding: "10px 14px",
                }}
              >
                <div
                  style={{
                    fontSize: 10,
                    fontFamily: "monospace",
                    color: item.highlight ? color : "#374151",
                ...
                <div
                  style={{ fontSize: 12, color: "#cbd5e1", lineHeight: 1.65 }}
                >
                  {item.value}
                </div>
              </div>
      ...
      return (
        <div key={idx} style={{ marginBottom: 20 }}>
          ...
          <div
            style={{
              display: "grid",
              gridTemplateColumns: `repeat(${Math.min(block.phases.length, 2)}, 1fr)`,
              gap: 10,
            }}
          >
      ...
      return (
        <div key={idx} style={{ marginBottom: 20 }}>
          ...
          <div
            style={{
              display: "grid",
              gridTemplateColumns: cols <= 2 ? `repeat(${cols}, 1fr)` : "1fr 1fr",
              gap: 10,
            }}
          >
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Icterícia Neonatal — Guia Completo
        </h1>
        <div
          style={{
            fontSize: 11,
        ...
        >
          Conceito · Tipos · Ind. Não Hemolítica · Ind. Hemolítica · Direta /
          Colestase · Fototerapia / TTO
        </div>
      </div>
