...
const sections = [
  {
    ...
    content: {
      ...
      blocks: [
        ...
        {
          type: "obs",
          title: "EONS Calculator (Kaiser Permanente) — Ferramenta de Estratificação",
  ...
  },
  {
    ...
    content: {
      ...
      blocks: [
        ...
        {
          type: "obs",
          title: "Profilaxia GBS — Drogas e Janela de Eficácia (< 4h = Inadequada)",
  ...
  },
  {
    ...
    content: {
      ...
      blocks: [
        ...
        {
          type: "grades",
          title: "Critérios Hematológicos — Rodwell Modificado (Critérios de Benitz)",
          organ: "Parâmetro",
          grades: [
            {
              grade: "I/T",
        ...
        <div key={idx} style={{ marginBottom: 20 }}>
          ...
          <div
            style={{
              display: "grid",
              gridTemplateColumns:
                cols <= 2 ? `repeat(${cols}, 1fr)` : "1fr 1fr",
              gap: 10,
            }}
          >
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Conceito · Sepse Precoce · Clínica e Exames · Manejo Clínico · Sepse
          Tardia · Tratamento
        </div>
      </div>
